...
def matriz_laplaciana_dispersa(M,t=double):
    e = sparse.eye(M, dtype=t) - sparse.eye(M, M, 1, dtype= t)
    return(e+e.T)
...
i=0
while i<10:
    M=[2,3,5,7,10,12,15,20,30,40,50, 70, 100, 150, 200, 300, 500, 750, 1000, 1800, 2500, 4000, 4500, 5250, 6700,10000, 50000, 120000]
    for j in M:     
        t1 = perf_counter()
        A=matriz_laplaciana_dispersa(j, double)
...
arch = open("Caso_solve_dispersa.txt", "w")
x = 0
