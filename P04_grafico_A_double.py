...
arch1 = open("Caso A.1 con float64 (double).txt", "r")
arch2 = open("Caso A.2 con float64 (double).txt", "r")
arch3 = open("Caso A.3 con float64 (double).txt", "r")
arch4 = open("Caso A.4 con float64 (double).txt", "r")
arch5 = open("Caso A.5 con float64 (double).txt", "r")
arch6 = open("Caso A.6 con float64 (double).txt", "r")
arch7 = open("Caso A.7 con float64 (double).txt", "r")
...
plt.figure(1)
plt.subplot(2,1,1)
plt.title("Rendimiento A todos los casos double")
i=0
j=0
while i < 10:
    while j < len(mat1):
