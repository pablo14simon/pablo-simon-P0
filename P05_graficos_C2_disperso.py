...
arch2 = open("Caso_2_dispersa.txt", "r")
...
x2 = ["10","20","50","100","200","500","1000","2000","5000","10000","20000","50000","100000","200000","500000","1000000","2000000","5000000","10000000"]
T2 = [10,20,50,100,200,500,1000,2000,5000,10000,20000,50000,100000,200000,500000,1000000,2000000,5000000,10000000]
...
plt.figure(1)
plt.subplot(2,1,1)
plt.title("Rendimiento caso 2")
i=0
j=0
while i < 10:
    while j < len(mat1):
        plt.loglog(tamaño2[j:j+22],tiempo_e_2[j:j+22], "o-",alpha=0.3,ms=3,color="k")
        j+=M
    i+=1
...
plt.ylim(bottom=dt2[0], top=dt2[-1])
plt.grid()
...
while i < 10:
    while j < len(mat1):
        plt.loglog(tamaño2[j:j+22],tiempo_c_2[j:j+22], "o-",alpha=0.3,ms=3,color="k")
        j+=M
    i+=1
...
plt.xticks(T2, x2)
plt.xlim(right=20000)
plt.ylim(bottom=dt2[0], top=dt2[-3])
plt.grid()
