...
arch = open("Caso A.1 con float64 (double).txt", "w")
...
arch = open("Caso A.2 con float64 (double).txt", "w")
arch.write("Tiempo de calculo(s)   Tamaño matriz \n")
b = 0
while b < len(tiempo1):
...
arch = open("Caso A.3 con float64 (double).txt", "w")
arch.write("Tiempo de calculo(s)   Tamaño matriz \n")
c = 0
while c < len(tamaño2):
...
arch = open("Caso A.4 con float64 (double).txt", "w")
arch.write("Tiempo de calculo(s)   Tamaño matriz \n")
d = 0
while d < len(tamaño3):
...
arch = open("Caso A.5 con float64 (double).txt", "w")
arch.write("Tiempo de calculo(s)   Tamaño matriz \n")
e = 0
while e < len(tiempo4):
...
arch = open("Caso A.6 con float64 (double).txt", "w")
arch.write("Tiempo de calculo(s)   Tamaño matriz \n")
f = 0
while f < len(tamaño5):
...
arch = open("Caso A.7 con float64 (double).txt", "w")
arch.write("Tiempo de calculo(s)   Tamaño matriz \n")
g = 0
while g < len(tamaño6):
