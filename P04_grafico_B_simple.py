...
arch1 = open("Caso B.1 con float32 (simple).txt", "r")
arch2 = open("Caso B.2 con float32 (simple).txt", "r")
arch3 = open("Caso B.3 con float32 (simple).txt", "r")
arch4 = open("Caso B.4 con float32 (simple).txt", "r")
arch5 = open("Caso B.5 con float32 (simple).txt", "r")
arch6 = open("Caso B.6 con float32 (simple).txt", "r")
arch6 = open("Caso B.6 con float32 (simple).txt", "r")
arch7 = open("Caso B.7 con float32 (simple).txt", "r")
arch8 = open("Caso B.8 con float32 (simple).txt", "r")
arch9 = open("Caso B.9 con float32 (simple).txt", "r")
...
plt.figure(1)
plt.subplot(2,1,1)
plt.title("Rendimiento B todos los casos single")
i=0
j=0
while i < 10:
    while j < len(mat1):
