...
arch = open("Caso B.1 con float32 (simple).txt", "w")
...
arch = open("Caso B.2 con float32 (simple).txt", "w")
arch.write("Tiempo de calculo(s)   Tamaño matriz \n")
b = 0
while b < len(tiempo1):
...
arch = open("Caso B.3 con float32 (simple).txt", "w")
arch.write("Tiempo de calculo(s)   Tamaño matriz \n")
c = 0
while c < len(tamaño2):
...
arch = open("Caso B.4 con float32 (simple).txt", "w")
arch.write("Tiempo de calculo(s)   Tamaño matriz \n")
d = 0
while d < len(tamaño3):
...
arch = open("Caso B.5 con float32 (simple).txt", "w")
arch.write("Tiempo de calculo(s)   Tamaño matriz \n")
e = 0
while e < len(tiempo4):
...
arch = open("Caso B.6 con float32 (simple).txt", "w")
arch.write("Tiempo de calculo(s)   Tamaño matriz \n")
f = 0
while f < len(tamaño5):
...
arch = open("Caso B.7 con float32 (simple).txt", "w")
arch.write("Tiempo de calculo(s)   Tamaño matriz \n")
g = 0
while g < len(tamaño6):
...
arch = open("Caso B.8 con float32 (simple).txt", "w")
arch.write("Tiempo de calculo(s)   Tamaño matriz \n")
h = 0
while h < len(tiempo4):
...
arch = open("Caso B.9 con float32 (simple).txt", "w")
arch.write("Tiempo de calculo(s)   Tamaño matriz \n")
i = 0
while i < len(tamaño8):
