...
arch1 = open("Caso_solve_llena.txt", "r")
...
x1 = ["10","20","50","100","200","500","1000","2000","5000","10000","20000","50000","100000","200000","500000","1000000","2000000","5000000"]
T1 = [10,20,50,100,200,500,1000,2000,5000,10000,20000,50000,100000,200000,500000,1000000,2000000,5000000]

y1 = ["0.1 ms", "1 ms", "10 ms","0.1 s", "1 s", "10 s", "1 min"]
dt1 = [0.1/1000,1/1000,10/1000,0.1,1,10]
...
eje_x_1=[tamaño1[0],tamaño1[-1]]

eje_y_2=[principio**2,fin]
eje_x_2=[tamaño1[0]**2,tamaño1[-1]]

eje_y_3=[principio**3,fin]
eje_x_3=[tamaño1[0]**3,tamaño1[-1]]

eje_y_4=[principio**4,fin]
eje_x_4=[tamaño1[0]**4,tamaño1[-1]]
